...
class Index_EweiShopV2Page extends WebPage 
{
	...
	public function payset() 
	{
		...
		if( $_W["ispost"] ) 
		{
			...
			if(!empty($inputdata["cash2_pay"])){ //2019-2-18阿飞添加线下付款
				$data["cash2_pay"]=$inputdata["cash2_pay"];
			}
			if(!empty($inputdata["lkl_pay"])){ //2020-2-19阿飞添加线拉卡拉支付
				$data["lkl_pay"]=$inputdata["lkl_pay"];
			}
