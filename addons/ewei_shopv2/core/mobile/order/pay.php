...
class Pay_EweiShopV2Page extends MobileLoginPage
{
	...
	public function main()
	{
		...
		// 2020-2-19阿飞添加拉卡拉支付 start
		if($lklpay['success']){
			$payinfo['lkl_pay'] = $lklpay_set['lkl_pay'];
		}
		// 2020-2-19阿飞添加拉卡拉支付 end
