define(['core', 'tpl'], function (core, tpl) {
    ...
    modal.getList = function () {
        ...
        geolocation.getCurrentPosition(function (r) {
            ...
            core.json('shequ/list/ajaxshequuser', {page: modal.page, keyword: modal.keyword, cateid: modal.cateid, lat: modal.lat, lng: modal.lng, range: modal.range, sorttype: modal.sorttype}, function (ret) {
                ...
                modal.page++;
                core.tpl('.container', 'tpl_shequ_list_user', result, modal.page > 2);
