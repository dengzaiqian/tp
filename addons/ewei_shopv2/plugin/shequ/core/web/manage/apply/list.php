...
class List_EweiShopV2Page extends shequWebPage
{
    protected function applyData($status, $st)
    {
        ...
        $psize = 20;
        $condition = " and b.uniacid=:uniacid and b.status=:status and b.shequid=:shequid and b.creditstatus = 2";
        ...
        $sql = "select b.* from " . tablename("ewei_shop_shequ_bill") . " b " . " left join " . tablename("ewei_shop_shequ_user") . " u on b.shequid = u.id" . " where 1 " . $condition . " ORDER BY " . $orderby . " desc ";
    ...
    protected function post()
    {
        ...
        global $_GPC;
        $shequid = $_W["shequid"];
        $item = $this->model->getshequPrice($shequid, 1);
        $list = $this->model->getshequPriceList($shequid);
