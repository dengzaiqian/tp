...
class Log_EweiShopV2Page extends shequWebPage
{
	public function main() 
	{
		...
		$condition = " and log.uniacid=:uniacid and posterid=" . intval($_GPC["id"])." and poster.shequid=".$_W['shequid'];
