...
class Goods_trans_EweiShopV2Page extends shequWebPage
{
	public function main()
	{
		global $_W;
		global $_GPC;
		$condition = ' and og.uniacid=' . $_W['uniacid'] . ' and og.shequid=' . $_W['shequid'];
		...
		$condition1 = ' and g.uniacid=:uniacid and g.shequid=:shequid';
