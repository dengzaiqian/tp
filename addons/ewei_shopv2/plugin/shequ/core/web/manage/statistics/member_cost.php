...
class Member_cost_EweiShopV2Page extends shequWebPage
{
	public function main()
	{
		global $_W;
		global $_GPC;
		$condition = ' and o.uniacid=' . $_W['uniacid'] . ' and o.shequid=' . $_W['shequid'];
		...
		$condition1 = ' and m.uniacid=:uniacid and m.openid in ( SELECT distinct openid from ' . tablename('ewei_shop_order') . '   WHERE uniacid =:uniacid and shequid=:shequid)';
