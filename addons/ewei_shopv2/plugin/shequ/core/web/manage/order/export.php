...
class Export_EweiShopV2Page extends shequWebPage 
{
	...
	public function main() 
	{
		...
		if( $_GPC["export"] == 1 ) 
		{
			...
			$status = $_GPC["status"];
			$condition = " o.uniacid = :uniacid and o.shequid = :shequid and o.isparent=0 and o.deleted=0";
			...
			foreach( $list as &$value ) 
			{
				...
				{
					$value["storeinfo"] = pdo_fetchcolumn("select storename from " . tablename("ewei_shop_shequ_store") . " where id=:storeid limit 1 ", array( ":storeid" => $value["verifystoreid"] ));
				}
		...
		$stores = pdo_fetchall("select id,storename from " . tablename("ewei_shop_shequ_store") . " where uniacid=:uniacid and shequid = :shequid", array( ":uniacid" => $_W["uniacid"], ":shequid" => $_W["shequid"] ));
