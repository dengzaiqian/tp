...
class Map_EweiShopV2Page extends PluginMobilePage
{
	public function main()
	{
		...
		$store = pdo_fetch('select * from ' . tablename('ewei_shop_shequ_user') . ' where id=:shequid and uniacid=:uniacid Limit 1', array(':uniacid' => $_W['uniacid'], ':shequid' => $shequid));
		$store['storename'] = $store['shequname'];
