...
(100,100,'friendcoupon','好友瓜分券','1.0','官方',1,'sale','../addons/ewei_shopv2/static/images/friendcoupon.png','',0,0,1),
(120, 120, 'goodscircle',  '好物圈', '1.0', '官方', 1,'tool', '../addons/ewei_shopv2/static/images/goodscircle.png', '购物版的朋友圈', 0, 0, 1),
(140,140,'open_farm','人人农场','1.0','官方',1,'tool','../addons/ewei_shopv2/static/images/open_farm.png','',0,0,1);
...
ALTER TABLE `ims_ewei_shop_exchange_setting` ADD COLUMN `coupon_templateid` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' AFTER `rule`;
ALTER TABLE `ims_ewei_shop_task_list` ADD COLUMN `poster_version` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' AFTER `member_level`;
ALTER TABLE `ims_ewei_shop_task_qr` ADD COLUMN `poster_version` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' AFTER `ticket`;

ALTER TABLE `ims_ewei_shop_abonus_level` ADD COLUMN `commissionmoney`  decimal(10,2) NULL DEFAULT 0.00 AFTER `downcount`;
...
ALTER TABLE `ims_ewei_shop_exchange_group` ADD COLUMN `goods_native`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `chufaend`;

ALTER TABLE `ims_ewei_shop_order_goods` ADD COLUMN `consume`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `title`;
ALTER TABLE `ims_ewei_shop_order_goods` ADD COLUMN `single_refundid`  int(11) NOT NULL DEFAULT 0 AFTER `consume`;
ALTER TABLE `ims_ewei_shop_order_goods` ADD COLUMN `single_refundstate`  tinyint(3) NOT NULL DEFAULT 0 AFTER `single_refundid`;
ALTER TABLE `ims_ewei_shop_order_goods` ADD COLUMN `single_refundtime`  int(11) NOT NULL DEFAULT 0 AFTER `single_refundstate`;
...
ALTER TABLE `ims_ewei_shop_task_list` ADD COLUMN `we7_rule_keyword_id`  int(10) NOT NULL DEFAULT 0 AFTER `poster_version`;

ALTER TABLE `ims_ewei_shop_virtual_data` ADD COLUMN `is_top`  tinyint(1) NULL DEFAULT 0 AFTER `createtime`;
ALTER TABLE `ims_ewei_shop_virtual_data` ADD COLUMN `sort_time`  int(11) NULL DEFAULT 0 AFTER `is_top`;
ALTER TABLE `ims_ewei_shop_virtual_type` ADD COLUMN `description`  text CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `recycled`;

ALTER TABLE `ims_ewei_shop_commission_level` ADD COLUMN `goodsids_text`  varchar(2000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' AFTER `goodsids`;
ALTER TABLE `ims_ewei_shop_commission_level` ADD COLUMN `level`  int(3) NOT NULL DEFAULT 0 AFTER `goodsids_text`;

ALTER TABLE `ims_ewei_shop_creditshop_log` ADD COLUMN `pay_time`  int(11) NULL DEFAULT 0 AFTER `merchapply`;


ALTER TABLE `ims_ewei_shop_coupon` ADD COLUMN `isfriendcoupon`  int(11) NULL DEFAULT 0 AFTER `templateid`;
ALTER TABLE `ims_ewei_shop_coupon_data` ADD COLUMN `friendcouponid`  int(11) NULL DEFAULT 0 AFTER `textkey`;
...
INSERT INTO `ims_ewei_shop_member_message_template_type` (`id`, `name`, `typecode`, `templatecode`, `templateid`, `templatename`, `content`, `showtotaladd`, `typegroup`, `groupname`) VALUES
(85,'好友瓜分券活动发起通知','friendcoupon_launch','OPENTM415477060','','业务处理通知','{{first.DATA}}业务类型：{{keyword1.DATA}}处理状态：{{keyword2.DATA}}处理内容：{{keyword3.DATA}}{{remark.DATA}}',0,'friendcoupon','好友瓜分券'),
(86,'好友瓜分券活动完成通知','friendcoupon_complete','OPENTM415477060',' ','业务处理通知','{{first.DATA}}业务类型：{{keyword1.DATA}}处理状态：{{keyword2.DATA}}处理内容：{{keyword3.DATA}}{{remark.DATA}}',0,'friendcoupon','好友瓜分券'),
(87,'好友瓜分券活动失败通知','friendcoupon_failed','OPENTM415477060',' ','业务处理通知','{{first.DATA}}业务类型：{{keyword1.DATA}}处理状态：{{keyword2.DATA}}处理内容：{{keyword3.DATA}}{{remark.DATA}}',0,'friendcoupon','好友瓜分券');
...
ALTER TABLE `ims_ewei_shop_express` ADD COLUMN `coding`  varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' AFTER `code`;
ALTER TABLE `ims_ewei_shop_fullback_log` ADD COLUMN `optionid`  int(11) NOT NULL DEFAULT 0 AFTER `goodsid`;
...
DELAY_KEY_WRITE=0
;
ALTER TABLE `ims_ewei_shop_goods` MODIFY COLUMN `content`  longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `description`;
...
DELAY_KEY_WRITE=0
;
ALTER TABLE `ims_ewei_shop_order_goods` ADD COLUMN `fullbackid`  int(11) NOT NULL DEFAULT 0 AFTER `single_refundtime`;

ALTER TABLE `ims_ewei_shop_goods` ADD COLUMN `manydeduct2`  tinyint(1) NULL DEFAULT 0 AFTER `beforehours`;
...
DELAY_KEY_WRITE=0
;
ALTER TABLE `ims_ewei_shop_goods_option` MODIFY COLUMN `thumb`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `title`;
ALTER TABLE `ims_ewei_shop_upwxapp_log` ADD COLUMN `is_goods`  tinyint(1) NULL DEFAULT 0 AFTER `version_time`;



ALTER TABLE `ims_ewei_shop_cashier_pay_log` ADD COLUMN `client_ip`  varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' AFTER `refunduser`;

ALTER TABLE `ims_ewei_shop_pc_adv` ADD COLUMN `settings`  text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL AFTER `height`;
...
DELAY_KEY_WRITE=0
;
ALTER TABLE `ims_ewei_shop_pc_menu` ADD COLUMN `status`  tinyint(3) UNSIGNED NULL DEFAULT 1 AFTER `createtime`;
ALTER TABLE `ims_ewei_shop_pc_menu` ADD COLUMN `create_time`  int(11) UNSIGNED NULL DEFAULT NULL AFTER `status`;
...
DELAY_KEY_WRITE=0
;
ALTER TABLE `ims_ewei_shop_system_plugingrant_log` ADD COLUMN `deleted`  tinyint(3) NOT NULL DEFAULT 0 AFTER `createtime`;
...
ALTER TABLE `ims_ewei_shop_merch_user` MODIFY COLUMN `sets`  mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL AFTER `accountid`;
...
ALTER TABLE `ims_ewei_shop_goods` ADD COLUMN `refund`  tinyint(3) NOT NULL DEFAULT 0 AFTER `membercardpoint`;
ALTER TABLE `ims_ewei_shop_goods` ADD COLUMN `returngoods`  tinyint(3) NOT NULL DEFAULT 0 AFTER `refund`;
ALTER TABLE `ims_ewei_shop_goods` ADD COLUMN `exchange`  tinyint(3) NOT NULL DEFAULT 0 AFTER `returngoods`;
ALTER TABLE `ims_ewei_shop_goods` ADD COLUMN `isdiscount_time_start`  int(11) NOT NULL AFTER `exchange`;
ALTER TABLE `ims_ewei_shop_order_peerpay_payinfo` ADD COLUMN `paytype`  tinyint(1) NOT NULL DEFAULT 0 AFTER `openid`;



drop table ims_ewei_shop_express;
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_express` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) DEFAULT '',
  `express` varchar(50) DEFAULT '',
...
DELAY_KEY_WRITE=0
;
ALTER TABLE `ims_ewei_shop_order` ADD COLUMN `wxapp_allow_subscribe`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `dividend_content`;
ALTER TABLE `ims_ewei_shop_order_refund` ADD COLUMN `ordergoodsids`  varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL AFTER `merchid`;
